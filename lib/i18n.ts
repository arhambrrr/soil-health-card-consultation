...
const CROP_TRANSLATIONS: Record<string, Record<string, string>> = {
  "hi-IN": {
    Paddy: "धान", Wheat: "गेहूं", Maize: "मक्का", Mustard: "सरसों",
    Pulses: "दालें", Potato: "आलू", Cotton: "कपास", Sugarcane: "गन्ना",
    Barley: "जौ", Soybean: "सोयाबीन", Jowar: "ज्वार", Tur: "अरहर",
    Ragi: "रागी", Groundnut: "मूंगफली", Sunflower: "सूरजमुखी",
    Chilli: "मिर्च", Banana: "केला",
  },
  "te-IN": {
    Paddy: "వరి", Wheat: "గోధుమలు", Maize: "మొక్కజొన్న", Mustard: "ఆవాలు",
    Pulses: "పప్పు ధాన్యాలు", Cotton: "పత్తి", Sugarcane: "చెరకు",
    Groundnut: "వేరుశెనగ", Chilli: "మిరప", Sunflower: "పొద్దుతిరుగుడు",
    Jowar: "జొన్నలు", Tur: "కంది", Banana: "అరటి",
  },
  "kn-IN": {
    Paddy: "ಭತ್ತ", Wheat: "ಗೋಧಿ", Maize: "ಮೆಕ್ಕೆಜೋಳ", Mustard: "ಸಾಸಿವೆ",
    Cotton: "ಹತ್ತಿ", Sugarcane: "ಕಬ್ಬು", Groundnut: "ಶೆಂಗಾ",
    Jowar: "ಜೋಳ", Ragi: "ರಾಗಿ", Sunflower: "ಸೂರ್ಯಕಾಂತಿ",
    Chilli: "ಮೆಣಸಿನಕಾಯಿ", Banana: "ಬಾಳೆ",
  },
  "mr-IN": {
    Paddy: "भात", Wheat: "गहू", Maize: "मक्का", Mustard: "मोहरी",
    Cotton: "कापूस", Sugarcane: "ऊस", Soybean: "सोयाबीन",
    Jowar: "ज्वारी", Tur: "तूर", Groundnut: "भुईमूग",
    Chilli: "मिरची", Banana: "केळ",
  },
  "ta-IN": {
    Paddy: "நெல்", Wheat: "கோதுமை", Maize: "சோளம்", Mustard: "கடுகு",
    Cotton: "பருத்தி", Sugarcane: "கரும்பு", Groundnut: "நிலக்கடலை",
    Banana: "வாழை", Chilli: "மிளகாய்",
  },
  "bn-IN": {
    Paddy: "ধান", Wheat: "গম", Maize: "ভুট্টা", Mustard: "সর্ষে",
    Pulses: "ডাল", Potato: "আলু", Cotton: "তুলা", Sugarcane: "আখ",
    Banana: "কলা",
  },
  "gu-IN": {
    Paddy: "ડાંગર", Wheat: "ઘઉં", Maize: "મકાઈ", Mustard: "રાઈ",
    Cotton: "કપાસ", Sugarcane: "શેરડી", Groundnut: "મગફળી",
    Banana: "કેળા", Chilli: "મરચાં",
  },
};
